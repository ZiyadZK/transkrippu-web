...
export default function AkunPage() {
    ...
    const submitFormTambah = async (e, modal) => {
        ...
        if(formTambah['id_pegawai_akun'] === '' || formTambah['nama_akun'] === '') {
            return
        }
        ...
        Swal.fire({
            ...
            didOpen: async () => {
                const response = await M_Akun_create(formTambah)
                                            ...
                                            {filteredDataPegawai.slice(0, 20).map((value, index) => (
                                                <label key={index} htmlFor={index} className="flex items-center w-full justify-between p-3 border dark:border-zinc-800 hover:border-zinc-700 dark:hover:border-zinc-400 rounded-lg text-xs cursor-pointer ease-out duration-200 has-[:checked]:border-zinc-400">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <input type="radio" id={index} value={value['id_pegawai']} checked={formTambah['id_pegawai_akun'] == value['id_pegawai']} onChange={() => setFormTambah(state => ({...state, nama_akun: value['nama_pegawai'], id_pegawai_akun: value['id_pegawai']}))} name="radio" className="" />
                                                    </div>
                                                </label>
                                            ))}
                                        </div>
                                        ...
                                        <div className="flex items-center gap-2 flex-col md:flex-row px-2 py-3">
                                            ...
                                            <p className="w-full md:w-2/3">
                                                <label className="input input-bordered flex items-center gap-2 input-sm dark:bg-zinc-800 bg-zinc-100">
                                                    ...
                                                    <input type="text" required className="grow" value={formTambah['email_akun']} onChange={e => setFormTambah(state => ({...state, email_akun: e.target.value}))}  placeholder="Email" />
                                                </label>
                                            </p>
                                        </div>
                                        <div className="flex items-center gap-2 flex-col md:flex-row px-2 py-3">
                                                ...
                                                <div className="w-full divide-y h-fit dark:divide-zinc-800 ">
                                                    ...
                                                    <div className="flex items-center gap-2 flex-col md:flex-row px-2 py-3">
                                                        ...
                                                        <p className="w-full md:w-2/3">
                                                            <label className="input input-bordered flex items-center gap-2 input-sm dark:bg-zinc-800 bg-zinc-100">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path d="M2.5 3A1.5 1.5 0 0 0 1 4.5v.793c.026.009.051.02.076.032L7.674 8.51c.206.1.446.1.652 0l6.598-3.185A.755.755 0 0 1 15 5.293V4.5A1.5 1.5 0 0 0 13.5 3h-11Z" /><path d="M15 6.954 8.978 9.86a2.25 2.25 0 0 1-1.956 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z" /></svg>
                                                                <input disabled type="text" className="grow" defaultValue={value['email_akun']} placeholder="Email" />
                                                            </label>
                                                        </p>
                                                    </div>
                                                    <div className="flex items-center gap-2 flex-col md:flex-row px-2 py-3">
                                                        ...
                                                        <p className="w-full md:w-2/3">
                                                            <label className="input input-bordered flex items-center gap-2 input-sm dark:bg-zinc-800 bg-zinc-100">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path fillRule="evenodd" d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z" clipRule="evenodd" /></svg>
                                                                <input disabled type="text" className="grow" defaultValue={value['password_akun']} placeholder="Password" />
                                                            </label>
                                                        </p>
                                                    </div>
                                                    <div className="flex items-center gap-2 flex-col md:flex-row px-2 py-3">
                                                        ...
                                                        <p className="w-full md:w-2/3">
                                                            <select disabled defaultValue={value['role_akun']} className="select select-bordered w-full select-sm dark:bg-zinc-800 bg-zinc-100">
                                                                <option value={''} disabled >-- Pilih Role --</option>
                                                                <option value="Operator">Operator</option>
                                                                <option value="Admin">Admin</option>
                                                            </select>
                                                ...
                                                <div className="w-full divide-y h-fit dark:divide-zinc-800 ">
                                                    ...
                                                    <div className="flex items-center gap-2 flex-col md:flex-row px-2 py-3">
                                                        ...
                                                        <p className="w-full md:w-2/3">
                                                            <label className="input input-bordered flex items-center gap-2 input-sm dark:bg-zinc-800 bg-zinc-100">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path d="M2.5 3A1.5 1.5 0 0 0 1 4.5v.793c.026.009.051.02.076.032L7.674 8.51c.206.1.446.1.652 0l6.598-3.185A.755.755 0 0 1 15 5.293V4.5A1.5 1.5 0 0 0 13.5 3h-11Z" /><path d="M15 6.954 8.978 9.86a2.25 2.25 0 0 1-1.956 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z" /></svg>
                                                                <input type="text" className="grow" defaultValue={value['email_akun']} placeholder="Email" />
                                                            </label>
                                                        </p>
                                                    </div>
                                                    <div className="flex items-center gap-2 flex-col md:flex-row px-2 py-3">
