...
import { M_Matpel_getAll } from "@/models/M_Matpel"
import { M_Nilai_create, M_Nilai_getAll } from "@/models/M_Nilai"
        ...
        Swal.fire({
            ...
            if(answer.isConfirmed) {
                Swal.fire({
                    ...
                    allowEnterKey: false,
                    didOpen: async () => {
                        const response = await M_Nilai_create({...payload, nis: detailSiswa['nis']})
